/**
 * "easytimer.js" library created by -- Albert González
 * original code at -- https://github.com/albert-gonzalez/easytimer.js#readme
 * This code originally belongs to the above credited author
 * There is no intention of claiming it as my own
 */
  ...
  function m() {
    ...
    function V(t, e) {
      ...
      return (
        (function (t, e) {
          var n = v[t];
          ((P[t] = e),
            (A[t] = t === l ? Math.abs(e) : y(e >= 0 ? e : n - y(e, n), n)));
        })(e, B(t, p[e])),
        P[e] !== n
      );
    }
    ...
    function k(n) {
      (X() ? ((O = I()), (b = F(m.target))) : R(n),
        (function () {
          var n = p[e];
          if (N(C(Date.now()))) return;
          ((t = setInterval(_, n)), (E = !0), (D = !1));
        })());
    }
    function I() {
      return C(Date.now()) - P.secondTenths * p[c] * o;
    }
    function _() {
      var t = C(Date.now());
      (!(function (t) {
        t[c] && Q("secondTenthsUpdated", x);
        t[a] && Q("secondsUpdated", x);
        t[f] && Q("minutesUpdated", x);
        t[h] && Q("hoursUpdated", x);
        t[l] && Q("daysUpdated", x);
      })(z()),
        i(x.detail.timer),
        N(t) && (H(), Q("targetAchieved", x)));
    }
    function z() {
      var t =
          arguments.length > 0 && void 0 !== arguments[0]
    ...
    function R(t) {
      ...
      ((e = (function (t) {
        ...
        (i = "function" == typeof t.callback ? t.callback : function () {}),
        (w = !0 === t.countdown),
        (o = !0 === w ? -1 : 1),
    ...
    function F(t) {
      if (t) {
        var e = G((b = q(t)));
        return ((j = O + e.secondTenths * p[c] * o), b);
      }
    }
    function G(t, e) {
      var n = e || {};
